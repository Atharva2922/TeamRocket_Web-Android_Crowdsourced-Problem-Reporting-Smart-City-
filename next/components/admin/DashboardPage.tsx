  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatsCard title="Total Issues" value="1,284" icon={Activity} trend={{ value: '+12%', isPositive: true }} color="blue" />
        <StatsCard title="Pending" value="342" icon={AlertCircle} trend={{ value: '+5%', isPositive: false }} color="red" />
        <StatsCard title="In Progress" value="456" icon={Clock} trend={{ value: '+18%', isPositive: true }} color="yellow" />
        <StatsCard title="Resolved" value="486" icon={CheckCircle2} trend={{ value: '+24%', isPositive: true }} color="green" />
      </div>
