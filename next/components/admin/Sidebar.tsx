  ...
  return (
    ...
    >
      <div className="p-6 flex items-center gap-3 border-b border-slate-100">
        ...
        {!isCollapsed && (
          <span className="font-bold text-slate-800 text-lg whitespace-nowrap overflow-hidden">Smart City Admin</span>
        )}
      </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && !isCollapsed && <div className="ml-auto w-1.5 h-1.5 rounded-full bg-blue-600" />}
            </button>
          );
        })}
      </nav>
